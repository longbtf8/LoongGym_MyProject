...
export default function MobileSidebar({ isOpen, setIsOpen }) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed inset-y-0 left-0 w-64 border-r border-[var(--border-color)]/60 bg-[var(--bg-secondary)] flex flex-col z-50 transition-transform duration-300 lg:hidden`}
      >
        {/* Brand Header */}
